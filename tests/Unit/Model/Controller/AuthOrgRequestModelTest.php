...
use Hippy\Api\Model\Controller\AuthOrgRequestModel;
use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpFoundation\Request;

/** @coversDefaultClass \Hippy\Api\Model\Controller\AuthOrgRequestModel */
class AuthOrgRequestModelTest extends TestCase
{
    /**
     * @return void
     * @covers ::__construct
    ...
    {
        $request = new Request();
        $model = new AuthOrgRequestModel($request);
